                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex">
                                        <div>
                                        <a href="doctors.php" class="non-style-link-menu"><div><p class="menu-text">Today Sessions</p></div></a>
                                ...
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex; ">
                                        <div>
                                        <a href="appointment.php" class="non-style-link-menu"><div><p class="menu-text">New Bookings</p></div></a>
                                ...
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;padding-top:26px;padding-bottom:26px;">
                                        <div>
                                        <a href="schedule.php" class="non-style-link-menu"><div><p class="menu-text">Today Sessions</p></div></a>
